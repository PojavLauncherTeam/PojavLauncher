...
public final class Tools {
    ...
    public static void initContextConstants(Context ctx){
       ...
       /* if (LauncherPreferences.PREF_PATH_CHANGE_HACK){
        ...
        if(SDK_INT >= 29 && LauncherPreferences.PREF_PATH_SET_HACK.equals("/storage/emulated/0/games/PojavLauncher/")) {
            DIR_GAME_HOME = ctx.getExternalFilesDir(null).getAbsolutePath();
        }
        if (LauncherPreferences.PREF_PATH_SET_HACK.equals("/storage/emulated/0/games/PojavLauncher/") && SDK_INT <= 29){
DIR_GAME_HOME = new File(Environment.getExternalStorageDirectory(),"games/PojavLauncher").getAbsolutePath();
}
if (LauncherPreferences.PREF_PATH_SET_HACK.equals("/storage/emulated/0/Android/data/net.kdt.pojavlaunch.debug/") && SDK_INT <= 29){
DIR_GAME_HOME = ctx.getExternalFilesDir(null).getAbsolutePath();
}
