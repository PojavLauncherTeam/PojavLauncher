    ...
    public class RTViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            if(view.getId() == R.id.multirt_view_removebtn) {
                ...
                final ProgressDialog barrier = new ProgressDialog(view.getContext());
                barrier.setMessage(view.getContext().getString(R.string.global_waiting));
        ...
        public void bindRuntime(Runtime runtime, int pos) {
            ...
            if(runtime.versionString != null && Tools.DEVICE_ARCHITECTURE == Architecture.archAsInt(runtime.arch)) {
                mJavaVersionTextView.setText(mJavaVersionTextView.getContext().getString(R.string.multirt_java_ver, runtime.name, runtime.javaVersion));
            ...
            if(runtime.versionString == null){
                ...
                mFullJavaVersionTextView.setText(mFullJavaVersionTextView.getContext().getString(R.string.multirt_runtime_incompatiblearch, runtime.arch));
            }
