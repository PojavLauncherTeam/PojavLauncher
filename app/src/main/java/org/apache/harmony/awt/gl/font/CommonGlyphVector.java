...
public class CommonGlyphVector extends GlyphVector {
    ...
    public float[] getGlyphPositions(int beginGlyphIndex, int numEntries,
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(visualPositions, beginGlyphIndex, positionReturn, 0, numEntries);
    ...
    public void setGlyphPositions(int beginGlyphIndex, int numEntries,
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(setPositions, 0, visualPositions, beginGlyphIndex, numEntries);
        layoutFlags = layoutFlags & FLAG_HAS_POSITION_ADJUSTMENTS;
    ...
    public void setGlyphPositions(float[] setPositions) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(setPositions, 0, visualPositions, 0, len);
        layoutFlags = layoutFlags & FLAG_HAS_POSITION_ADJUSTMENTS;
    ...
    public void performDefaultLayout() {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(logicalPositions, 0, visualPositions, 0, logicalPositions.length);
