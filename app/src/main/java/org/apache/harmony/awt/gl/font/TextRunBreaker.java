...
public class TextRunBreaker implements Cloneable {
    ...
    public void insertChar(AttributedCharacterIterator newParagraph, int insertPos) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(text, 0, newText, 0, insertPos);
        newText[insertPos] = insChar;
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(text, insertPos, newText, insertPos+1, text.length - insertPos);
        text = newText;
    ...
    public void deleteChar(AttributedCharacterIterator newParagraph, int deletePos) {
        ...
        char newText[] = new char[text.length - 1];
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(text, 0, newText, 0, deletePos);
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(text, deletePos+1, newText, deletePos, newText.length - deletePos);
        text = newText;
