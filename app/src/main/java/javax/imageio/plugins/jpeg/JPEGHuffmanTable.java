...
public class JPEGHuffmanTable {
    ...
    public JPEGHuffmanTable(short[] lengths, short[] values) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(lengths, 0, this.lengths, 0, lengths.length);
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(values, 0, this.values, 0, values.length);
    }
    ...
    public short[] getLengths() {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(lengths, 0, newLengths, 0, lengths.length);
        return newLengths;
    }
    ...
    public short[] getValues() {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(values, 0, newValues, 0, values.length);
        return newValues;
    }
