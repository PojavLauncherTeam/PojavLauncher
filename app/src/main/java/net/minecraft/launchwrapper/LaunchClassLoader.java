...
public class LaunchClassLoader extends DexClassLoader {
    ...
    public LaunchClassLoader() { //String launchDexPath, String launchOptimizedDirectory, String launchLibrarySearchPath, ClassLoader parentClassLoader) {
        super(LaunchClassLoaderAgruments.launchDexPath, LaunchClassLoaderAgruments.launchOptimizedDirectory, LaunchClassLoaderAgruments.launchLibrarySearchPath, LaunchClassLoader.class.getClassLoader());
