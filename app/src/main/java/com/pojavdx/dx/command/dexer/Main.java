...
import com.pojavdx.dx.Version;
import com.pojavdx.dx.cf.code.SimException;
import com.pojavdx.dx.cf.direct.ClassPathOpener;
import com.pojavdx.dx.cf.direct.ClassPathOpener.FileNameFilter;
import com.pojavdx.dx.cf.direct.DirectClassFile;
import com.pojavdx.dx.cf.direct.StdAttributeFactory;
import com.pojavdx.dx.cf.iface.ParseException;
import com.pojavdx.dx.command.UsageException;
import com.pojavdx.dx.dex.DexOptions;
import com.pojavdx.dx.dex.cf.CfOptions;
import com.pojavdx.dx.dex.cf.CfTranslator;
...
import com.pojavdx.dx.merge.CollisionPolicy;
import com.pojavdx.dx.merge.DexMerger;
...
public class Main {
    ...
    public static void main(String[] argArray) throws IOException {
        ...
        if (result != 0) {
            System.out.print("Exiting with code " + result);
        }
    }
    ...
    private boolean processAllFiles() {
        ...
        if (args.jarOutput) {
			try {
				OutputStream out = openOutput(args.outName + ".cache");
	...
	private class OutputResources {
		...
		public void done() throws IOException {
			...
			File outCache = new File(args.outName + ".cache");
			if (!outCache.renameTo(outFile)) {
