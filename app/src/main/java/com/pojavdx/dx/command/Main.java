...
package com.pojavdx.dx.command;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    com.pojavdx.dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    com.pojavdx.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    com.pojavdx.dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    com.pojavdx.dx.command.findusages.Main.main(without(args, i));
                    break;
            ...
            ex.printStackTrace();
            System.out.print("Exiting with code " + 2);
        } catch (Throwable ex) {
            ...
            System.out.print("Exiting with code " + 3);
        }
        ...
        if (showUsage) {
            usage();
            System.out.print("Exiting with code " + 1);
        }
    }
    ...
    private static void version() {
        ...
        System.out.print("Exiting with code " + 0);
    }
