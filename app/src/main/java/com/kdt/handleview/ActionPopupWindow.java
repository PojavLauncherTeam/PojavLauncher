		...
		if (view == mEditTextView) {
			...
			dialog.setOnShowListener(new DialogInterface.OnShowListener() {
					...
					public void onShow(DialogInterface dialogInterface) {
						...
						spinnerKeycode.setSelection(Android2LWJGLKeycode.getIndexByAndroidKey(properties.keycode));
						/*
						if (properties.keyindex < specialArr.length) {
							...
							spinnerKeycode.setSelection(properties.keyindex + specialArr.length);
						}
						*/
						...
						button.setOnClickListener(new View.OnClickListener() {
								...
								public void onClick(View view2) {
									if (editName.getText().toString().isEmpty()) {
										...
										properties.keycode = Android2LWJGLKeycode.getKeyIndex(spinnerKeycode.getSelectedItemPosition());
										...
										if (properties.keyindex < specialArr.length) {
											properties.keycode = properties.keyindex - specialArr.length;
											properties.name = ControlButton.getSpecialButtons()[properties.keyindex].name;
										}
