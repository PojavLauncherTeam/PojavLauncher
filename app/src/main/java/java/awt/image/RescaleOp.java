...
public class RescaleOp implements BufferedImageOp, RasterOp {
    ...
    public RescaleOp(float[] scaleFactors, float[] offsets, RenderingHints hints) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(scaleFactors, 0, this.scaleFactors, 0, numFactors);
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(offsets, 0, this.offsets, 0, numFactors);
    ...
    public final float[] getScaleFactors(float[] scaleFactors) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(this.scaleFactors, 0, scaleFactors, 0, minLength);
        return scaleFactors;
    }
    ...
    public final float[] getOffsets(float[] offsets) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(this.offsets, 0, offsets, 0, minLength);
        return offsets;
    }
    ...
    private final void createLevels(SampleModel sm, int numBands, boolean skipAlpha, int levels[],
        ...
        if (scaleFactors.length != 1) {
            net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(scaleFactors, 0, extScaleFactors, 0, scaleFactors.length);
            net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(offsets, 0, extOffsets, 0, scaleFactors.length);
        } else {
            for (int i = 0; i < numBands; i++) {
        ...
        if (channelsOrder != null) {
            ...
            net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(levels, 0, savedLevels, 0, len);
            net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(values, 0, savedValues, 0, len);
            for (int i = 0; i < channelsOrder.length; i++) {
                net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(savedLevels, i * 4, levels, channelsOrder[i] * 4, 4);
                net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(savedValues, i * 4, values, channelsOrder[i] * 4, 4);
            }
        }
    }
