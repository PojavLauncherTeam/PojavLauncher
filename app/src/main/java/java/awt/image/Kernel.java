...
public class Kernel implements Cloneable {
    ...
    public Kernel(int width, int height, float[] data) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(data, 0, this.data, 0, dataLength);
    ...
    public final float[] getKernelData(float[] data) {
        ...
        net.kdt.pojavlaunch.SystemCrackResolver.arraycopy(this.data, 0, data, 0, this.data.length);
