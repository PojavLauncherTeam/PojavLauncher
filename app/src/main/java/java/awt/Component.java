...
public abstract class Component implements ImageObserver, MenuContainer, Serializable {
     ...
     * The Constant peer.
     */
    protected static final ComponentPeer peer = new ComponentPeer() {
    };
     ...
     * 
	 ...
	 AWTComponentHandler; protected FocusListener
    ...
    // ???AWT:
	// protected transient AccessibleContext accessibleContext;
	...
	Window getWindowAncestor() {
		Component par; for (par = this; par != null && !(par instanceof Window); par = par.getParent()) { ; }
		return (Window) par;
	}
