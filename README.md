...
---------
* From [Boardwalk](https://github.com/zhuowei/Boardwalk)'s ashes comes PojavLauncher!

* PojavLauncher is a launcher that allows you to play Minecraft: Java Edition on your Android device!

* It can run almost any version of Minecraft, allowing you to use .jar only installers to install modloaders such as [Forge](https://files.minecraftforge.net/), [Fabric](http://fabricmc.net/), and [Optifine](https://optifine.net); as well as utility and hack clients such as [LabyMod](https://www.labymod.net/en), [Wurst](https://www.wurstclient.net/) and much more!
...
* This repository contains source code for the Android version; for iOS/iPadOS, check out [PojavLauncher_iOS](https://github.com/PojavLauncherTeam/PojavLauncher_iOS).
...
## Building
<!--old sentence (i couldn't understand the "after launcher code changes" part): If you want to build after launcher code changes, follow the steps below.-->
...
- Follow the build instructions on the build script's [README.md](https://github.com/PojavLauncherTeam/android-openjdk-build-multiarch/blob/buildjre8/README.md).
...
* Either get the `jre8-pojav` artifact from auto builds, or do the splitting by yourself:</br>
   - Get JREs for all 4 supported architectures (arm, arm64, x86, x86_64) </br> 
...
- [x] Mod installer with GUI. Used the `Caciocavallo` project for AWT without X11.
...
- [x] Rewritten the entire controls system (thanks to @Mathias-Boulay)
- [ ] More to come!
...
## Contributing
Contributions are welcome! We welcome any type of contribution, not only code. For example, you can help by improving the wiki. You can also help via [translating](https://crowdin.com/project/pojavlauncher) this project.
